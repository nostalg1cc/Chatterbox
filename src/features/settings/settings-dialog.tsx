...
export function SettingsDialog({ buttonLabel, trigger }: { buttonLabel?: string; trigger?: ReactNode }) {
  ...
  return (
    ...
    >
      {trigger ? <DialogTrigger asChild>{trigger}</DialogTrigger> : <Tooltip>
